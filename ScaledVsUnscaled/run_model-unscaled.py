...
from Function import run_model_randomInit_unscaled, run_model_unscaled
...
if args.input == 'pbmc10k': 
    adata = read_h5ad('/home/jupyter/mount/gdrive/PBMC/pbmc10k/pbmc10k.h5ad')

if args.input == 'pbmc3k': 
    adata = sc.read_h5ad('/home/jupyter/mount/gdrive/PBMC/pbmc3k/pbmc3k.h5ad')
...
if   args.initialisation=='PCA':
    ...
    Trained=run_model_unscaled(adata)
